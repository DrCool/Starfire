...
Type `cd lib`, then type `./server.rb` to run the server on port 2000.
...
In a separate terminal window, type: `docker run --read-only -it -p 2200:2200 --name lands-code-runner lands-code-runner`
